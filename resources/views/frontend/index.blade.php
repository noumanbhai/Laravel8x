...
<div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="{{asset('frontend/assets/img/portfolio/portfolio-3.jp')}}g" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>App 2</h4>
              <p>App</p>
    ...
    <section id="clients" class="clients">
      ...
      <img src="{{ URL::to('/') }}/images/{{ $brand->brand_image }}" class=" mx-auto d-block" alt="" style="width: 110%;height: 160%;">
            </div>
          </div>
              @endforeach
