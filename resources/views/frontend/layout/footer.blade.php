...
echo $contacts->first()->address;
@endphp
             <br><br>
            <strong>Phone:</strong>@php
$contacts = DB::table('contacts')->get();
echo $contacts->first()->contact;
@endphp<br>
            <strong>Email:</strong>@php
$contacts = DB::table('contacts')->get();
echo $contacts->first()->email;
@endphp<br>
          </p>
        </div>
  ...
  <div class="container d-md-flex py-4">
    ...
    <div class="mr-md-auto text-center text-md-left">
      <div class="copyright">
        &copy; Copyright <strong><span><a href="/">Enigatix</a></span></strong>. All Rights Reserved
      </div>
      <div class="credits">
